...
def main(
    method_name : str, extract_text_func, 
    ...
    for category in pbar:
        ...
        # get tfidf acc
        score_tfidf_acc(sim_matrix, category, method_name)
        ...
        for i in tqdm(range(1, 6)):
            # define save path
            savepath = os.path.join(savedir, f'sim_index_{target}_{i}th.json')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yaml_config', type=str, help='config filename', default='configs/tfidf/full_full.yaml')
