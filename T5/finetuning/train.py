...
def main(args):
    ...
    if args.validation:
        valid_dataset = full_dataset['valid'].map(
            preprocess,
            batched=True,
            fn_kwargs = {'max_source_length': 512, 
                        'max_target_length': 32, 
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        eval_steps=3000, # 3000
        logging_strategy="steps",
        logging_steps=3000, # 3000
        save_strategy="steps",
        save_steps=3000,
...
if __name__== "__main__":    
    ...
    parser.add_argument("--model_path", type=str, default="KETI-AIR/ke-t5-base-newslike")
