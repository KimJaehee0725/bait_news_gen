...
def run(cfg):
    ...
    for split in cfg['MODE']['test_list']:
        ...
        exp_results['label'] = exp_results['filename'].apply(lambda x: 1 if ('Base' in x) or ("Auto" in x) else 0)
...
if __name__=='__main__':
    ...
    parser.add_argument('--saved_model_path', type=str, default='../saved_model/News_Base/best_model.pt', help='saved_model_path')
