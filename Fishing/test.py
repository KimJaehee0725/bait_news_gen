...
def run(cfg):
    ...
    model.load_state_dict(torch.load('/workspace/code/Fake-News-Detection-Dataset/saved_model/content_chunking_forward/News_Direct/best_model.pt'))  #! 원하는 모델 경로로 수정
    model.to(device)
...
if __name__=='__main__':
    ...
    parser.add_argument('--yaml_config', type=str, default="/workspace/code/Fake-News-Detection-Dataset/Fishing/configs/Detection.yaml", help='exp config file')    
